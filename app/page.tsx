...
export default function HomePage() {
  return (
    <>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 pt-[152px] pb-24">
          <div className="text-center max-w-[820px] mx-auto">
            <ScrollReveal direction="up">
              ...
              <p className="text-xl text-text-secondary max-w-[520px] mx-auto mb-10 leading-relaxed">
      ...
      <div className="bg-neutral leading-0 text-0" aria-hidden="true">
        <svg viewBox="0 0 1440 52" preserveAspectRatio="none" className="block w-full h-[52px] text-base-100" style={{ color: 'var(--base-100)' }}>
      ...
      {/* 3. PROBLEM */}
      <section className="bg-neutral pt-24 pb-24" id="about">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <ScrollReveal direction="left">
              <div>
                <div className="text-xs font-bold tracking-[3px] uppercase text-primary mb-5">Why AI Program?</div>
                <h2 className="text-4xl md:text-3xl font-bold leading-tight text-text-inverse mb-3">Why do I need an AI Program?</h2>
                ...
                <ul className="flex flex-col gap-4">
                  {[
                    ...
                    <li key={text} className="flex items-start gap-3.5 text-sm text-text-secondary">
                      <span className="flex-shrink-0 w-5.5 h-5.5 mt-0.5 bg-primary/12 border border-primary/35 rounded-full flex items-center justify-center text-primary">
      ...
      <div className="bg-neutral leading-0 text-0" aria-hidden="true">
        <svg viewBox="0 0 1440 52" preserveAspectRatio="none" className="block w-full h-[52px] text-base-100" style={{ color: 'var(--base-100)' }}>
          <polygon points="0,0 1440,52 0,52" fill="currentColor" />
        </svg>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <ScrollReveal direction="up">
            <div className="text-center mb-14">
              <div className="text-xs font-bold tracking-[3px] uppercase text-secondary mb-3">Client Stories</div>
      ...
      {/* MID CTA */}
      <section className="bg-gradient-to-r from-secondary to-secondary-800 py-18 px-6 text-center relative overflow-hidden">
        ...
        <ScrollReveal direction="up">
          ...
          <p className="text-base text-text-secondary max-w-[520px] mx-auto mb-9 leading-relaxed relative">Book a free strategy call and get your personalized AI roadmap in 30 minutes.</p>
          <Link href="#contact" className="inline-flex items-center gap-2 bg-surface-inverse text-text-primary text-sm font-semibold px-6 py-3.5 rounded-xl no-underline transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-white/30 relative">Book Free Strategy Call &rarr;</Link>
        </ScrollReveal>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
            <ScrollReveal direction="left">
              <div className="flex flex-col items-start">
                <div className="text-xs font-bold tracking-[3px] uppercase text-primary mb-3">Proven Results</div>
                <h2 className="text-4xl md:text-3xl font-bold text-text-inverse mb-6">Real Results for Real Businesses</h2>
                ...
                <Link href="#case-studies" className="inline-flex items-center gap-2 bg-primary text-primary-contrast text-sm font-semibold px-6 py-3.5 rounded-xl no-underline transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary">View Case Studies &rarr;</Link>
              </div>
            </ScrollReveal>
            <div className="flex flex-col gap-5">
              {[
                ...
                <ScrollReveal key={r.title} direction="right" delay={i * 100}>
                  <div className={`flex gap-6 bg-white/5 border border-white/8 border-l-3 rounded-r-2xl p-6 transition-all hover:bg-white/8 hover:translate-x-1 ${r.borderClass}`}>
                    <div className="flex flex-col items-center w-20 flex-shrink-0 pt-1">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-wide text-center leading-tight opacity-70">{r.microcopy}</span>
                    </div>
                    <div className="flex flex-col gap-1">
                      <h3 className="text-base font-semibold text-text-inverse leading-tight">{r.title}</h3>
      ...
      <section className="relative bg-neutral py-24 overflow-hidden" id="services">
        <div className="absolute inset-0 z-0">
          <Image src="/images/ai-workplace.jpg" alt="" fill className="object-cover opacity-20" />
          <div className="absolute inset-0 bg-gradient-to-b from-neutral/50 via-neutral/20 to-neutral/60" />
        </div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          <ScrollReveal direction="up">
            <div className="text-xs font-bold tracking-[3px] uppercase text-primary mb-3">What We Do</div>
            <h2 className="text-4xl md:text-3xl font-bold text-text-inverse mb-4">AI-Powered Solutions for a Tech-Forward Future</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
            {[
              { title: 'Build Your AI-Powered Brand',       desc: 'Go from unknown to industry leader — using AI content, positioning, and authority building.', href: '#contact', colorClass: 'text-secondary hover:text-secondary-400', borderColor: 'rgb(40,123,232)' },
              { title: 'Train Your Team to Lead with AI',  desc: 'Hands-on workshops that turn AI confusion into confident, rapid execution.', href: 'https://www.ai-officer.com/ai-in-business-events', colorClass: 'text-accent hover:text-accent-400', borderColor: 'rgb(209,69,139)' },
              { title: 'Automate Hiring & HR',             desc: 'Find, screen, and onboard talent faster with intelligent AI recruitment agents.', href: '#contact', colorClass: 'text-primary hover:text-primary-400', borderColor: 'rgb(111,242,193)' },
              { title: 'Accelerate Sales with AI',         desc: 'Deploy AI chatbots and CRM automations that nurture leads and close deals faster.', href: '#contact', colorClass: 'text-secondary hover:text-secondary-400', borderColor: 'rgb(40,123,232)' },
              { title: 'Dominate Social Media with AI',    desc: 'Create and publish high-performing content at scale — without burning out your team.', href: 'https://www.ai-officer.com/ai-in-business-events', colorClass: 'text-accent hover:text-accent-400', borderColor: 'rgb(209,69,139)' },
              { title: 'Scale with Global AI Talent',      desc: 'Hire top-tier AI-trained professionals from Vietnam in weeks, not months.', href: '#contact', colorClass: 'text-primary hover:text-primary-400', borderColor: 'rgb(111,242,193)' },
            ].map((s, i) => (
              <ScrollReveal key={s.title} direction="up" delay={i * 60}>
                <div className="bg-neutral/80 border border-white/10 border-t-2 rounded-xl p-6 flex flex-col h-full transition-all hover:-translate-y-1 hover:shadow-xl" style={{ borderTopColor: s.borderColor }}>
                  <h3 className="text-base font-bold text-text-inverse mb-2 leading-snug">{s.title}</h3>
      ...
      {/* 9. SOLUTIONS */}
      <section className="py-24 bg-surface-inverse" id="solutions">
        <div className="max-w-7xl mx-auto px-6">
          <ScrollReveal direction="up">
          ...
          <div className="flex flex-col">
            {[
              { label: 'AI Programs', subtitle: 'From Strategy to Implementation—We Build not Pitch', desc: "We don't just talk AI—we build with it. From CRM flows to marketing automation, our AI solutions power content creation, sales engagement, and customer journeys. You bring the ideas. We build the systems.", image: '/images/solutions/sol-ai-programs.jpg' },
              { label: 'Global Talent Network', subtitle: 'Scale Smarter with AI-Empowered Teams', desc: "Access Vietnam's top AI-trained professionals to accelerate your initiatives—without compromising on quality or speed. We embed engineers, analysts, and operators directly into your team to turn workflows into intelligent systems.", image: '/images/solutions/sol-global-talent.jpg' },
              { label: 'AI Officer Certification & Workshops', subtitle: 'Make Your Team AI-Literate and Leadership-Ready', desc: "We equip founders and teams to lead with confidence. Through our AI Officer certification and hands-on workshops, your organization will gain the frameworks, tools, and language to scale with AI—internally and externally.", image: '/images/solutions/sol-workshop.jpg' },
            ].map((s, i) => (
              <ScrollReveal key={s.label} direction="up" delay={i * 80}>
                <div className="grid grid-cols-1 md:grid-cols-2 border-t border-border overflow-hidden">
                  <div className="overflow-hidden">
                    <Image src={s.image} alt={s.label} width={560} height={480} className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                  </div>
                  <div className="flex flex-col justify-center p-10 md:p-14">
                    <div className="text-xs font-bold tracking-[2.5px] uppercase text-secondary mb-4">{s.label}</div>
                    <div className="h-px bg-border mb-5" />
                    <h3 className="text-xl font-bold text-text-primary mb-4 leading-snug">{s.subtitle}</h3>
                ...
                <div className="group rounded-2xl overflow-hidden transition-all hover:-translate-y-1.5 hover:shadow-xl">
                  <div className="relative w-full aspect-[4/3] overflow-hidden block">
                    ...
                    <a href={c.website} target="_blank" rel="noreferrer" className="absolute inset-0 flex items-center justify-center">
                      <span className="inline-flex items-center gap-1.5 text-sm font-semibold text-text-primary bg-surface-inverse px-5 py-2.5 rounded-full opacity-0 group-hover:opacity-100 transition-all -translate-y-2 group-hover:translate-y-0">View Website &rarr;</span>
                    </a>
      ...
      <section className="py-24 bg-base-100">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
            <ScrollReveal direction="left">
              <Link href="/blog/your-next-ai-hire" className="group bg-surface-inverse border border-border rounded-2xl overflow-hidden flex flex-col transition-all hover:border-secondary hover:-translate-y-1 hover:shadow-lg">
      ...
      <section className="bg-neutral">
        <div className="grid grid-cols-1 md:grid-cols-2 min-h-[500px]">
          <div className="flex flex-col justify-center p-16 md:p-20 relative">
            <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse at 0% 50%, rgba(40,123,232,0.18) 0%, transparent 70%)' }} />
            <div className="relative z-10">
              <h2 className="text-3xl font-bold text-text-inverse mb-3 leading-snug">Ready to transform your business with AI automation?</h2>
              <p className="text-base font-semibold text-primary mb-4">Schedule a Free AI Automation Review</p>
              ...
              <Link href="/services/ai-capabilities-audit" className="inline-flex items-center gap-2 bg-primary text-primary-contrast text-sm font-bold px-6 py-3.5 rounded-xl no-underline transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary self-start">Book Your AI Capabilities Audit &rarr;</Link>
            </div>
          </div>
      ...
      <section className="bg-neutral py-24 relative overflow-hidden" id="contact">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          <ScrollReveal direction="up">
            ...
            <p className="text-base text-text-secondary max-w-[640px] mx-auto leading-relaxed mb-16">Connect with Edge8&apos;s experts to explore AI Programs for your organization</p>
          </ScrollReveal>
          <ContactForm />
        </div>
      </section>
